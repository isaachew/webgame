...
function clev(el){
	...
	if(en.id[0]==="B"){
    	...
    	$("#buildgui").append(svgel("text",{"x":0,"y":0,"font-size":camvb[2]/60,"fill":"#ffffff","alignment-baseline":"hanging","text-anchor":"start","id":"buildbtntx1"},en.name+" Level "+en.level))
