		...
		case 0:
			if(ff){
				...
				$("#help").click(()=>{
					...
					$("#hcont").append(el("div",{"style":"top:10vh;width:100%;height:40vh;background-color:#ffffff;overflow:auto","id":"htext"},"Placeholder text"))
					$("#htext").text("Some text ".repeat(300))
					$("#chelp").click(()=>{
						$("#hblack,#hcont").remove()
					})
				})
